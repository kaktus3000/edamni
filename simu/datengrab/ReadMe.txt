========================================================================
    KONSOLENANWENDUNG: leapfrogsimu-Projektübersicht
========================================================================

Diese leapfrogsimu-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre leapfrogsimu-Anwendung besteht.


leapfrogsimu.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "leapfrogsimu.pch und eine 
